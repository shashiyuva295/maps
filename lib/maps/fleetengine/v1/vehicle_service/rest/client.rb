...
require "maps/fleetengine/v1/vehicle_service/rest/service_stub"
      ...
      module VehicleService
        module Rest
          ...
          class Client
            ...
            #
            # See {::Maps::Fleetengine::V1::VehicleService::Rest::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all VehicleService clients
            #   ::Maps::Fleetengine::V1::VehicleService::Rest::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            #   client = ::Maps::Fleetengine::V1::VehicleService::Rest::Client.new
            #
            ...
            def initialize
              ...
              @vehicle_service_stub = ::Maps::Fleetengine::V1::VehicleService::Rest::ServiceStub.new endpoint: @config.endpoint, credentials: credentials
            end
            ...
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Maps::Fleetengine::V1::Vehicle>]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Gapic::Rest::PagedEnumerable<::Maps::Fleetengine::V1::Vehicle>]
            #
            # @raise [::Google::Cloud::Error] if the REST call is aborted.
            #
            # @example Basic example
            ...
            #   @param current_trips_present [::Maps::Fleetengine::V1::SearchVehiclesRequest::CurrentTripsPresent]
            ...
            # {::Maps::Fleetengine::V1::VehicleService::Rest::Client::Configuration::Rpcs}
