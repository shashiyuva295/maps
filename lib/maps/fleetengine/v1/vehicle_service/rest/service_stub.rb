      ...
      module VehicleService
        module Rest
          ...
          class ServiceStub
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::CreateVehicleRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Maps::Fleetengine::V1::Vehicle]
            ...
            def create_vehicle request_pb, options = nil
              ...
              result = ::Maps::Fleetengine::V1::Vehicle.decode_json response.body, ignore_unknown_fields: true
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::GetVehicleRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::UpdateVehicleRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::UpdateVehicleLocationRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Maps::Fleetengine::V1::VehicleLocation]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            ...
            def update_vehicle_location request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Maps::Fleetengine::V1::VehicleLocation.decode_json response.body, ignore_unknown_fields: true
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::UpdateVehicleAttributesRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Maps::Fleetengine::V1::UpdateVehicleAttributesResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            ...
            def update_vehicle_attributes request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Maps::Fleetengine::V1::UpdateVehicleAttributesResponse.decode_json response.body, ignore_unknown_fields: true
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::ListVehiclesRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Maps::Fleetengine::V1::ListVehiclesResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Maps::Fleetengine::V1::ListVehiclesResponse]
            #   A result object deserialized from the server's reply
            def list_vehicles request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Maps::Fleetengine::V1::ListVehiclesResponse.decode_json response.body, ignore_unknown_fields: true
            ...
            #
            # @param request_pb [::Maps::Fleetengine::V1::SearchVehiclesRequest]
            #   A request object representing the call parameters. Required.
            # @param options [::Gapic::CallOptions]
            #   Overrides the default settings for this call, e.g, timeout, retries etc. Optional.
            #
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Maps::Fleetengine::V1::SearchVehiclesResponse]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            ...
            def search_vehicles request_pb, options = nil
              ...
              operation = ::Gapic::Rest::TransportOperation.new response
              result = ::Maps::Fleetengine::V1::SearchVehiclesResponse.decode_json response.body, ignore_unknown_fields: true
