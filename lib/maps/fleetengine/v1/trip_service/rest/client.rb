...
require "maps/fleetengine/v1/trip_service/rest/service_stub"
      ...
      module TripService
        module Rest
          ...
          class Client
            ...
            #
            # See {::Maps::Fleetengine::V1::TripService::Rest::Client::Configuration}
            # for a description of the configuration fields.
            #
            # @example
            #
            #   # Modify the configuration for all TripService clients
            #   ::Maps::Fleetengine::V1::TripService::Rest::Client.configure do |config|
            #     config.timeout = 10.0
            #   end
            #
            ...
            def initialize
              ...
              @trip_service_stub = ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.new endpoint: @config.endpoint, credentials: credentials
            end
            ...
            # @yield [result, operation] Access the result along with the TransportOperation object
            # @yieldparam result [::Gapic::Rest::PagedEnumerable<::Maps::Fleetengine::V1::Trip>]
            # @yieldparam operation [::Gapic::Rest::TransportOperation]
            #
            # @return [::Gapic::Rest::PagedEnumerable<::Maps::Fleetengine::V1::Trip>]
            #
            # @raise [::Google::Cloud::Error] if the REST call is aborted.
            #
            # @example Basic example
            ...
            # {::Maps::Fleetengine::V1::TripService::Rest::Client::Configuration::Rpcs}
