...
class ::Maps::Fleetengine::V1::TripService::Rest::ClientTest < Minitest::Test
  class ClientStub
  ...
  def test_create_trip
    # Create test objects.
    client_result = ::Maps::Fleetengine::V1::Trip.new
    ...
    ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.stub :transcode_create_trip_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, create_trip_client_stub do
        # Create client
        client = ::Maps::Fleetengine::V1::TripService::Rest::Client.new do |config|
        ...
        # Use protobuf object
        client.create_trip ::Maps::Fleetengine::V1::CreateTripRequest.new(header: header, parent: parent, trip_id: trip_id, trip: trip) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        client.create_trip(::Maps::Fleetengine::V1::CreateTripRequest.new(header: header, parent: parent, trip_id: trip_id, trip: trip), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_get_trip
    ...
    ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.stub :transcode_get_trip_request, ["", "", {}] do
  ...
  def test_report_billable_trip
    ...
    ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.stub :transcode_report_billable_trip_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, report_billable_trip_client_stub do
        ...
        # Use protobuf object
        client.report_billable_trip ::Maps::Fleetengine::V1::ReportBillableTripRequest.new(name: name, country_code: country_code, platform: platform, related_ids: related_ids, solution_type: solution_type) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.report_billable_trip(::Maps::Fleetengine::V1::ReportBillableTripRequest.new(name: name, country_code: country_code, platform: platform, related_ids: related_ids, solution_type: solution_type), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_search_trips
    # Create test objects.
    client_result = ::Maps::Fleetengine::V1::SearchTripsResponse.new
    http_response = OpenStruct.new body: client_result.to_json
    ...
    ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.stub :transcode_search_trips_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, search_trips_client_stub do
        ...
        # Use protobuf object
        client.search_trips ::Maps::Fleetengine::V1::SearchTripsRequest.new(header: header, parent: parent, vehicle_id: vehicle_id, active_trips_only: active_trips_only, page_size: page_size, page_token: page_token, minimum_staleness: minimum_staleness) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.search_trips(::Maps::Fleetengine::V1::SearchTripsRequest.new(header: header, parent: parent, vehicle_id: vehicle_id, active_trips_only: active_trips_only, page_size: page_size, page_token: page_token, minimum_staleness: minimum_staleness), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_update_trip
    ...
    ::Maps::Fleetengine::V1::TripService::Rest::ServiceStub.stub :transcode_update_trip_request, ["", "", {}] do
      Gapic::Rest::ClientStub.stub :new, update_trip_client_stub do
        ...
        # Use protobuf object
        client.update_trip ::Maps::Fleetengine::V1::UpdateTripRequest.new(header: header, name: name, trip: trip, update_mask: update_mask) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
        ...
        # Use protobuf object with options
        client.update_trip(::Maps::Fleetengine::V1::UpdateTripRequest.new(header: header, name: name, trip: trip, update_mask: update_mask), call_options) do |_result, response|
          assert_equal http_response, response.underlying_op
        end
  ...
  def test_configure
    ...
    assert_kind_of ::Maps::Fleetengine::V1::TripService::Rest::Client::Configuration, config
  end
end
