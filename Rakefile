...
namespace :test do
  ...
  task :coverage do
    require "simplecov"
    SimpleCov.start do
      command_name "google-maps-fleetengine-v1"
      track_files "lib/**/*.rb"
      add_filter "test/"
    end
...
# Acceptance tests
desc "Run the google-maps-fleetengine-v1 acceptance tests."
task :acceptance, :project, :keyfile do |t, args|
  ...
  ::Maps::Fleetengine::V1::TripService::Credentials.env_vars.each do |path|
    ENV[path] = nil
  end
...
namespace :acceptance do
  task :run do
    if File.directory? "acceptance"
      ...
      puts "The google-maps-fleetengine-v1 gem has no acceptance tests."
    end
  end
...
namespace :samples do
  task :latest do
    if File.directory? "samples"
      ...
      puts "The google-maps-fleetengine-v1 gem has no samples to test."
    end
  end
...
task :doctest do
  puts "The google-maps-fleetengine-v1 gem does not have doctest tests."
end

desc "Run the CI build"
task :ci do
  header "BUILDING google-maps-fleetengine-v1"
  header "google-maps-fleetengine-v1 rubocop", "*"
  Rake::Task[:rubocop].invoke
  header "google-maps-fleetengine-v1 yard", "*"
  Rake::Task[:yard].invoke
  header "google-maps-fleetengine-v1 test", "*"
  Rake::Task[:test].invoke
end
...
namespace :ci do
  ...
  task :smoke_test do
    Rake::Task[:ci].invoke
    header "google-maps-fleetengine-v1 smoke_test", "*"
    Rake::Task[:smoke_test].invoke
  end
  desc "Run the CI build, with acceptance tests."
  task :acceptance do
    Rake::Task[:ci].invoke
    header "google-maps-fleetengine-v1 acceptance", "*"
